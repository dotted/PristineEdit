...
namespace BadMechanics.PristineEdit.Common.Data.Loggers
{
    ...
    ///   &lt;common&gt;
    ///     &lt;logging&gt;
    ///       &lt;factoryAdapter type=&quot;Common.Logging.Simple.EventAggregatorOutFactoryAdapter, Common.Logging&quot;&gt;
    ...
    public class EventAggregatorOutFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
    {
        private readonly IEventAggregator eventAggregator;

        /// <summary>
        /// Initializes a new instance of the <see cref="EventAggregatorOutFactoryAdapter"/> class using default 
        /// settings.
        /// </summary>
        public EventAggregatorOutFactoryAdapter(IEventAggregator eventAggregator)
            : base(null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventAggregatorOutFactoryAdapter"/> class.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <param name="eventAggregator">The event aggrgator</param>
        /// <param name="properties">The key value collection, typically specified by the user in 
        /// a configuration section named common/logging.</param>
        public EventAggregatorOutFactoryAdapter(IEventAggregator eventAggregator, NameValueCollection properties)
            : base(properties)
        {
            this.eventAggregator = eventAggregator;
        }
        ...
        /// </summary>
        public EventAggregatorOutFactoryAdapter(IEventAggregator eventAggregator, LogLevel level, bool showDateTime, bool showLogName, bool showLevel, string dateTimeFormat)
        ...
        {
            ILog log = new EventAggregatorLogger(name, level, showLevel, showDateTime, showLogName, dateTimeFormat, this.eventAggregator);
            return log;
        }
    }
}
